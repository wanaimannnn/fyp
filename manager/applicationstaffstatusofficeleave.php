...
$query="SELECT * FROM request WHERE role='staff' AND status = false";
$result = mysqli_query($link,$query) or die('Query failed. ' . mysqli_error($link));
$q=mysqli_query($link,$query);
                            ...
                            <table class="table table-bordered table-hover">
                                  <thead>
                                    ...
                                    <tr align="center">
                                        ...
                                        <td><a href="applicationstaffofficeleave(form).php?no=<?php echo $row['no'];?>"><img src="../css/img/pencil.png" style="30" width="30"/> </a>
