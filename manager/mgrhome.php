                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="mgrdeplist(frontoffice).php">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-success class">
                            ...
                            <a href="mgrdeplist(housekeeping).php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-info class">
                            ...
                            <a href="mgrdeplist(maintenance).php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
            ...
            <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-danger class">
                            ...
                            <a href="mgrdeplist(landscape).php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            ...
                            <a href="mgrdeplist(humanresources).php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
				 ...
				 <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-info yellow">
                            ...
                            <a href="mgrdeplist(security).php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
