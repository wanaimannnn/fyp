         ...
         <div class="container-fluid">
             ...
             <div class="row">
                 <div class="col-sm-6 col-sm-offset-3">
                     ...
                     <form role="form" method="post" action="svsignupprocess.php" enctype="multipart/form-data">
                  ...
                  <th colspan="2"><center>Login Credential</center></td>
                        ...
                        <form role="form">
                         ...
                         <div class="form-group">
                            ...
                            <td> <input class="form-control" name="sv_username" placeholder="Enter the username requested" required></td>
                       ...
                       <tr>
                         ...
                         <div class="form-group">
                            ...
                            <td> <input type="password" class="form-control" name="sv_pwd" placeholder="Enter the password requested" required></td>

                         </div>
                       </tr>

                                 <input type="hidden" class="form-control" name="role" value="supervisor">
