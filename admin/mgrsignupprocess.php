...
$result = mysqli_query ($link,"INSERT INTO manager(name,ic,address,mobileno,position,department,gender,citizenstatus,race,religion,maritalstatus,email,mgr_username,mgr_pwd,role,profile) VALUES ('$name','$ic','$address','$mobileno','$position','$department','$gender','$citizenstatus','$race','$religion','$maritalstatus','$email','$username','$password','$role','$superdir')")
