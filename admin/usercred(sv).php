      ...
      <div id="page-wrapper">
         ...
         <div class="container-fluid">
             ...
             <div class="row">
                 <div class="col-lg-12">
                     ...
                     <ol class="breadcrumb">
                         ...
                         <li class="active">
                             <i class="fa fa-edit"></i> Supervisor
                         </li>
                     </ol>
                 </div>
             </div>
             ...
             <?php
                ...
                $query="SELECT * FROM supervisor WHERE no='$no'";
                $result = mysqli_query($link,$query) or die('Query failed. ' . mysqli_error($link));
                $q=mysqli_query($link,$query);
                while( $row = mysqli_fetch_assoc($result) )
                {
             ...
             <div class="row">
                 <div class="col-sm-6 col-sm-offset-3">
                     ...
                     <form role="form" method="post" action="credprocess(sv).php">
                         ...
                         <div class="form-group">
                             ...
                             <form role="form">
                              ...
                              <div class="form-group">
                                 ...
                                 <td> <input class="form-control" name="sv_username" value="<?php echo $row['sv_username']; ?>" required></td>
                              </div>
                            </tr>
                            <tr>
                              <td>
                              <div class="form-group">
                                 ...
                                 <td> <input type="text" class="form-control" name="sv_pwd" value="<?php echo $row['sv_pwd']; ?>" required></td>
