                         ...
                         <div class="form-group">
                             ...
                             <form role="form">
                              ...
                              <div class="form-group">
                                 ...
                                 <td> <input class="form-control" name="sv_username" value="<?php echo $row['sv_username']; ?>"></td>
                              </div>
                            </tr>
                            <tr>
                              <td>
                              <div class="form-group">
                                 ...
                                 <td> <input type="text" class="form-control" name="sv_pwd" value="<?php echo $row['sv_pwd']; ?>"></td>
