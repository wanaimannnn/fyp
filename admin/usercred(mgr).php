                         ...
                         <div class="form-group">
                             ...
                             <form role="form">
                              ...
                              <div class="form-group">
                                 ...
                                 <td> <input class="form-control" name="mgr_username" value="<?php echo $row['mgr_username']; ?>" required></td>
                              </div>
                            </tr>
                            <tr>
                              <td>
                              <div class="form-group">
                                 ...
                                 <td> <input type="text" class="form-control" name="mgr_pwd" value="<?php echo $row['mgr_pwd']; ?>" required></td>
