...
$result = mysqli_query ($link,"INSERT INTO staff (name,ic,address,mobileno,position,department,gender,citizenstatus,race,religion,maritalstatus,email,staff_username,staff_pwd,role,profile) VALUES ('$name','$ic','$address','$mobileno','$position','$department','$gender','$citizenstatus','$race','$religion','$maritalstatus','$email','$username','$password','$role','$superdir')")
