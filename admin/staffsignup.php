                  ...
                  <th colspan="2"><center>Login Credential</center></td>
                        ...
                        <form role="form">
                         ...
                         <div class="form-group">
                            ...
                            <td> <input class="form-control" name="staff_username" placeholder="Enter the username requested"></td>
                       ...
                       <tr>
                         ...
                         <div class="form-group">
                            ...
                            <td> <input type="password" class="form-control" name="staff_pwd" placeholder="Enter the password requested"></td>
