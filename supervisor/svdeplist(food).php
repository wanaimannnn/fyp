    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <?php
                ...
                $query="SELECT *
                        FROM manager WHERE department='Food & Beverages'
                        UNION ALL
                        SELECT *
                        FROM supervisor WHERE department='Food & Beverages'
                        UNION ALL
                        SELECT *
                        FROM staff WHERE department='Food & Beverages'";
                $result = mysqli_query($link,$query) or die('Query failed. ' . mysqli_error($link));
                $q=mysqli_query($link,$query);
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <i class="fa fa-table"></i> Food And Beverages
                                    </li>
                                </ol>
                            </div>
                        </div>
