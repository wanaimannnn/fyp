    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <?php
                ...
                $query="SELECT *
                        FROM manager WHERE department='Maintenance'
                        UNION ALL
                        SELECT *
                        FROM supervisor WHERE department='Maintenance'
                        UNION ALL
                        SELECT *
                        FROM staff WHERE department='Maintenance'";
                $result = mysqli_query($link,$query) or die('Query failed. ' . mysqli_error($link));
                $q=mysqli_query($link,$query);
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <i class="fa fa-table"></i> Maintenance
                                    </li>
                                </ol>
                            </div>
                        </div>
