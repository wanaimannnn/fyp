                            ...
                            <table class="table table-bordered table-hover">
                                  <thead>
                                    ...
                                    <tr align="center">
                                      ...
                                      ?></td>
                                        <td><a href="staffformupdate(officeleave).php?no=<?php echo $row['no'];?>"><img src="../css/img/contract.png" style="30" width="30"/> </a> &nbsp &nbsp <a href="staffformdelete(officeleave).php?no=<?php echo $row['no'];?>"><img src="../css/img/recycle-bin.png" style="30" width="30"/></a></td>
